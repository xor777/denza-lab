...
| `cloud-custom-runtime-contract.md` | Custom SIM awake alpha: protocol 3 service lease, installation generations, SIM-mode handoff, native boundaries, packaging gates and vehicle acceptance obligations. |
