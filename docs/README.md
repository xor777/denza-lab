...
| `cloud-custom-runtime-contract.md` | Custom SIM adapter: detached guardian, protocol 2, installation generations, native boundaries, packaging gates and live acceptance obligations. |
