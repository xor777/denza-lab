...
public final class CloudPrimitiveBridgeTest {
    ...
    static void primitives()throws Exception{
        ...
        for(String key:List.of("persist.sys.cloud.unlock_type","sys.cloud.unlock_uuid",
            ...
            // An unobserved private value is not a fabricated default or a stock read.
            try{p.call("PROPERTY_GET",List.of(hex(key)));throw new AssertionError();}
            catch(CloudNativePipe.ProtocolFailure expected){}
    ...
    public static void main(String[]args)throws Exception{
        primitives();privateCounterLifetime();incapableNativeCannotTouchPlatform();unavailableFirmwareIsNotNetworkRetry();
        System.out.println("PASS primitive forwarding and native capability gate cases=4");
    }
}
