...
fun DenzaAppsRoot(
    ...
    onSelectCloudMode: (dev.denza.apps.feature.cloud.CloudSimMode) -> Unit,
    onSaveCloudIdentity: (dev.denza.apps.feature.cloud.CloudIdentity) -> Unit,
    onRegenerateCloudIdentity: () -> Unit,
    ...
    val dashboardActions = remember(
        ...
        DashboardActions(
            ...
            onSelectCloudMode = onSelectCloudMode,
            onSaveCloudIdentity = onSaveCloudIdentity,
            onRegenerateCloudIdentity = onRegenerateCloudIdentity,
