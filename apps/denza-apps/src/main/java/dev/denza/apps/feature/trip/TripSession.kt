 ...
 * gaps in the data are possible and honest, but an active trip survives activity
 * relaunches and elapsed time is wall-clock from the trip start. Confirmed P ends
 * and clears it; nothing is persisted to disk.
 *
